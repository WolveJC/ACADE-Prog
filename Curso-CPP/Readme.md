...
- Ejercicios: reserva y liberación de memoria, gestión automática con smart pointers.
...
- Ejercicios: resolver problemas con recursión y luego con algoritmos estándar.
...
- Ejercicios: simulación de turnos en un banco, retroceso en algoritmos.
...
- Ejercicios: tabla de símbolos, gestión dinámica de datos.
...
- Comparación con std::map y std::set (Red-Black Trees).  
- Ejercicios: índice de biblioteca, árbol de decisiones.
...
- Ejercicios: guardar y recuperar listas/árboles desde archivo.
...
- Ejercicios: modelar un sistema de inventario con clases y herencia.
...
- Uso de std::function.  
- Ejercicios: algoritmos genéricos de ordenamiento y búsqueda con lambdas.
...
- Ejercicios: Implementacion continúa en todo el curso
