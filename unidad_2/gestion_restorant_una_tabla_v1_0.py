...
def ingresar_productos(lista_inventario: list):
    ...
    while True:
        ...
        if not codigo_input:
            ...
            # Uso de 'lista_inventario' (parámetro) en lugar de 'inventario' (global)
...
# ------------------------------------------
# 4. Función para visualizar y guardar cada tabla (Corregido E/W)
# ------------------------------------------
...
def generate_table_and_csv(
    ...
    Args:
        ...
        headers_visual: Encabezados para la visualización (Matplotlib).
    ...
    ax.axis("off")
    # Uso de headers_visual para la tabla
    ...
    try:
        with open(csv_filename, mode="w", newline="", encoding="utf-8") as csvfile:
            ...
            # Uso de csv_headers para el CSV
...
if __name__ == "__main__":
    ...
    # Variables locales para los encabezados
    ...
    for orden in ordenamientos_config:
        generate_table_and_csv(
            ...
            title=orden["title"],
            # Pasando los dos argumentos requeridos (headers_visual y csv_headers)
