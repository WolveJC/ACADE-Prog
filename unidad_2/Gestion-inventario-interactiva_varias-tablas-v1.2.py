...
inventario_por_cantidad = insertion_sort(inventario.copy(), key=lambda x: x["cantidad"], descending=False)
...
inventario_por_fecha = quick_sort(inventario.copy(), key=lambda x: datetime.datetime.strptime(x["fecha_limite"], "%Y-%m-%d"))
